...
const Hero = () => {
  ...
  const TimeBlock = ({ value, label }) => (
    <div className="flex flex-col items-center">
      ...
      <span className="text-xs text-secomp-text/80 mt-3 uppercase tracking-wider font-medium">
        {label}
      </span>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full mb-12 overflow-hidden">
        <div className="relative w-full overflow-hidden">
          ...
          <div className="absolute right-8 top-1/2 transform -translate-y-1/2 bg-secomp-card/95 backdrop-blur-sm border border-secomp-border rounded-3xl p-10 shadow-2xl">
            <p className="text-secomp-text uppercase tracking-widest text-sm mb-8 font-semibold text-center">
              Faltam
            </p>
      ...
      <div className="text-center max-w-6xl mx-auto px-4 md:px-0">
        ...
        <div className="mb-8">
          ...
          <div className="inline-flex items-center gap-3 bg-secomp-darker/50 border border-secomp-border/50 rounded-full px-8 py-4">
            ...
            <span className="font-mono text-secomp-cyan text-lg font-medium">
              Belém, Pará
            </span>
          </div>
        </div>
      ...
      <div className="w-full mt-16 mb-24 px-4">
        <div className="relative max-w-3xl mx-auto bg-secomp-card/80 backdrop-blur-sm border-2 border-gray-500/40 rounded-3xl p-12 shadow-2xl shadow-black/20 opacity-80">
          {/* Encerrado Banner */}
          ...
          <div className="flex items-center justify-center gap-4 mb-6 mt-2">
            <Sparkles className="w-10 h-10 text-secomp-cyan/50" />
            <h3 className="text-3xl font-bold text-white/60 text-center">
              Concurso: Chamada Criativa
            </h3>
          </div>
          <p className="text-secomp-text/60 text-lg leading-relaxed mb-6 text-center max-w-xl mx-auto">
            Chamada Criativa para escolha da logomarca da SECOMP.
          </p>
          {/* Deadline closed highlight */}
